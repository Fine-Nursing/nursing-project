      ...
      {showAvatarPicker && (
        <>
          ...
          >
            ...
            {/* Error Message */}
            {error && (
              <div className="px-4 py-3 mx-4 mt-4 bg-red-50 border border-red-200 rounded-lg">
            ...
            <div className="flex gap-2 pt-4 flex-shrink-0 border-t border-gray-200 dark:border-slate-600">
              {onReset && (
                <button
                  ...
                  onClick={onReset}
                  disabled={isLoading}
                  className={`px-3 py-2 rounded-lg font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 ${
                    theme === 'light'
                      ? 'bg-red-100 text-red-700 hover:bg-red-200 disabled:bg-gray-100 disabled:text-gray-400'
                      : 'bg-red-900 text-red-300 hover:bg-red-800 disabled:bg-slate-700 disabled:text-gray-500'
              ...
              <button
                ...
                className={`flex-1 px-4 py-2 rounded-lg font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 ${
                  theme === 'light'
                    ...
                    : 'bg-slate-700 text-gray-300 hover:bg-slate-600 disabled:bg-slate-800 disabled:text-gray-500'
                } ${isLoading ? 'cursor-not-allowed' : ''}`}
              >
                Cancel
              </button>
              <button
                ...
                className={`flex-1 px-4 py-2 rounded-lg font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 ${
                  theme === 'light'
                    ...
                    : 'bg-emerald-600 text-white hover:bg-emerald-700 disabled:bg-gray-600 disabled:text-gray-400'
                } ${isLoading ? 'cursor-not-allowed' : ''}`}
              >
