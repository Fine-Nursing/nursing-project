  ...
  const renderThumb = (thumb: 'left' | 'right') => {
    ...
    return (
      <button
        ...
        className="group absolute top-6 -ml-3 cursor-grab active:cursor-grabbing focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2"
        ...
        <div className="relative">
          <div
            className={`w-6 h-6 rounded-full transition-all duration-150
              ${
                activeThumb === thumb
                  ? 'scale-125 bg-blue-600 shadow-lg ring-4 ring-blue-100'
                  : 'bg-white border-2 border-blue-500 shadow-md hover:scale-110'
              }
            `}
          />
          <div
            className={`absolute -top-8 left-1/2 -translate-x-1/2 px-2 py-1 
              bg-blue-900 text-white text-xs rounded shadow-lg opacity-0 transition-opacity
