...
export default function AccountForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log(`${isSignIn ? 'Sign In' : 'Sign Up'} submitted:`, formData);
  };

  const handleSocialLogin = (provider: string) => {
    console.log(`${isSignIn ? 'Sign In' : 'Sign Up'} with ${provider}`);
  };
      ...
      <div className="max-w-md mx-auto bg-white p-8 rounded-2xl shadow-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Sign in to continue your nursing journey.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-purple-600 text-white py-3 px-4 rounded-lg hover:bg-purple-700 transition-colors font-medium shadow-sm"
          >
            Sign In
          </button>
          ...
          <div className="flex justify-center pt-4">
            <button
              ...
              className="text-slate-600 px-6 py-2.5 rounded-lg border border-slate-300 hover:bg-slate-50 transition-colors font-medium"
            >
              Back
            </button>
          </div>
