...
const CardBoard = lazy(() => import('src/components/CardBoard'));
...
export default function CompensationSection() {
  return (
    <section className="relative py-8 sm:py-16 px-4 sm:px-6 lg:px-8 bg-white/30 dark:bg-black transition-all">
      {/* Section divider */}
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          className="w-full bg-gradient-to-br from-white via-emerald-50/30 to-blue-50/50 dark:from-zinc-950 dark:via-neutral-950 dark:to-zinc-950 p-4 sm:p-10 rounded-2xl shadow-xl border border-emerald-100/50 dark:border-zinc-800 backdrop-blur-sm overflow-hidden"
        >
