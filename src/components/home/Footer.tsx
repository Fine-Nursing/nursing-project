      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="col-span-1 sm:col-span-2 md:col-span-2">
            ...
            <p className="text-sm sm:text-base text-zinc-400 mb-4">
              Empowering nurses to build extraordinary careers through data-driven insights and personalized career management tools.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <button type="button" className="text-sm sm:text-base text-slate-400 hover:text-white transition-colors text-left">
                  About Us
                </button>
              </li>
              <li>
        ...
        <div className="mt-6 sm:mt-8 pt-6 sm:pt-8 border-t border-zinc-800 text-center">
          <p className="text-xs sm:text-sm text-zinc-500">
            © 2024 Nurse Journey. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
