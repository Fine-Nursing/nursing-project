    ...
    >
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-6 sm:mb-10">
          <div className="inline-flex items-center justify-center px-4 py-1 mb-4 text-xs font-semibold tracking-wide text-blue-600 dark:text-blue-400 uppercase bg-blue-100 dark:bg-blue-900/20 dark:border dark:border-blue-800 rounded-full">
            Compensation Data
          </div>
        ...
        <div className="mt-8 sm:mt-12">
          <motion.div
            ...
            className="w-full bg-gradient-to-br from-white via-blue-50/30 to-teal-50/50 dark:from-zinc-950 dark:via-neutral-950 dark:to-zinc-950 p-4 sm:p-10 rounded-2xl shadow-xl border border-blue-100/50 dark:border-zinc-800 backdrop-blur-sm overflow-hidden"
          >
            {/* Header Section */}
            ...
            {/* Table Content */}
            <div className="bg-white/50 dark:bg-neutral-900/50 backdrop-blur-sm rounded-xl p-3 sm:p-6 border border-white/50 dark:border-zinc-800 shadow-sm relative z-10">
              <Suspense
                fallback={
                  <div className="h-64 sm:h-96 bg-gray-100 dark:bg-zinc-900 animate-pulse rounded-lg flex items-center justify-center">
