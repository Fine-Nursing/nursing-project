...
export default function UserProfileCard({
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 bg-gradient-to-bl from-slate-400 to-cyan-500 text-white px-3 py-1 rounded-bl-lg flex items-center">
      ...
      <div className="flex flex-wrap">
        ...
        <div className="w-full md:w-1/4 flex justify-center mb-4 md:mb-0">
          <div className="w-32 h-32 rounded-full bg-gradient-to-r from-slate-100 to-cyan-100 flex items-center justify-center relative">
            ...
            <div className="space-y-1">
              <div className="flex items-center">
                ...
                <span className="flex items-center">
                  {userProfile.role}
                  <Stethoscope className="w-4 h-4 ml-1 text-slate-500" />
                </span>
              </div>
              <div className="flex items-center">
